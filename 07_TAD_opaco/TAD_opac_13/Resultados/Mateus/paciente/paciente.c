 ...
 *
 * @param p Ponteiro para a estrutura de dados tPaciente contendo as informações
 * do paciente.
...
/**
 * @brief Retorna a quantidade de cirurgias necessárias para tratar as lesões do
 * paciente.
 *
 * @param p Ponteiro para a estrutura de dados tPaciente contendo as informações
 * do paciente.
 * @return Retorna a quantidade de cirurgias necessárias para tratar as lesões
 * do paciente.
 */
 ...
 *
 * @return Retorna um ponteiro para a estrutura de dados tPaciente contendo as
 * informações lidas.
 */
 ...
 * @param p Ponteiro para a estrutura de dados tPaciente contendo as informações
 * do paciente.
 * @param l Ponteiro para a estrutura de dados tLesao contendo as informações da
 * lesão.
 */
